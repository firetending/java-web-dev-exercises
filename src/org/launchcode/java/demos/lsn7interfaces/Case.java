...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Jimmies", 0.05, new ArrayList<>(Arrays.asList("red #5")));
        Topping topping2 = new Topping("Butterfingers", 0.5, new ArrayList<>(Arrays.asList("dairy","nuts")));
        Topping topping3 = new Topping("Cookie Dough", .7, new ArrayList<>(Arrays.asList("dairy","gluten")));
        Topping topping4 = new Topping("Cherries", .15, new ArrayList<>(Arrays.asList("red #5")));
